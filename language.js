...
const translations = {
    en: {
        "hero_eyebrow": "Steam Marketplace · Interactive Data Story",
        "hero_title": "50,000+ games. What does the data\nactually reveal about how we play?",
        "hero_sub": "Six interactive visualisations built from real Steam data —\neach one answers a question you didn't know you had.",
        "stat_games": "3,139",
        "stat_games_label": "Games tracked",
        "stat_viz": "6",
        "stat_viz_label": "Visualisations",
        "stat_months": "13mo",
        "stat_months_label": "of data",
        "explore": "Explore",
        "stories_label": "The stories",
        "stories_headline": "Each chapter is a different lens on the same marketplace.\nClick any card to go deeper.",
        "explore_cta": "Explore →",
        "arc_index": "01 — Arc Graph",
        "arc_question": "Do gamers ever truly change their minds?",
        "arc_insight": "Tracks how the review sentiment of 3,139 top-reviewed games has shifted — and how often that shift is a slide downward.",
        "arc_tag": "3,139 games · Apr 2026",
        "arc_improving": "improving",
        "arc_worsening": "worsening",
        "ccu_index": "02 — CCU Graph",
        "ccu_question": "Which games keep players coming back — and which vanish overnight?",
        "ccu_insight": "Concurrent player curves over 13 months, revealing which titles build lasting communities versus one-week wonders.",
        "ccu_tag": "13 months · Player retention",
        "ccu_long_tail": "Long tail",
        "ccu_flash": "Flash-in-the-pan",
        "dial_index": "03 — Dial Graph",
        "dial_question": "What is the absolute best game — by any measure you choose?",
        "dial_insight": "Spin four concentric rings — Genre, Metric, Player type, Platform — and find the cream of the crop for your exact filters.",
        "dial_tag": "4 axes · Interactive rings",
        "dial_genre": "GENRE",
        "dial_metric": "METRIC",
        "dial_player": "PLAYER",
        "dial_best": "BEST",
        "dial_of_best": "OF BEST",
        "treemap_index": "04 — Treemap",
        "treemap_question": "Who really controls the Steam marketplace?",
        "treemap_insight": "A nested map of publishers and their developers — see who dominates by volume, and how much territory the giants actually hold.",
        "treemap_tag": "40+ publishers · Dev breakdown",
        "spiral_index": "05 — Spiral Graph",
        "spiral_question": "How has game release volume evolved — year by year, genre by genre?",
        "spiral_insight": "A time spiral that winds each year outward, revealing waves of releases, seasonal patterns, and the long arc of Steam's growth.",
        "spiral_tag": "Time series · Release history",
        "radar_index": "06 — Radar Chart",
        "radar_question": "Is a game with 10 million players truly better than one with 100,000?",
        "radar_insight": "Compare any two games across six dimensions simultaneously — rating, sales, players, retention, reviews, and hours played.",
        "radar_tag": "6 dimensions · Head-to-head",
        "radar_rating": "RATING",
        "radar_sales": "SALES",
        "radar_players": "PLAYERS",
        "radar_retention": "RETENTION",
        "radar_reviews": "REVIEWS",
        "radar_hours": "HOURS",
        "radar_game_a": "Game A",
        "radar_game_b": "Game B",
        "data_provenance": "Data provenance",
        "data_tagline": "All visualisations draw from three complementary sources, collected and cross-referenced in April 2026.",
        "source_api_icon": "",
        "source_api_name": "Steam Store API",
        "source_api_desc": "Game metadata, review scores, and ownership estimates pulled directly from Valve's public endpoints. Covers titles with at least 10 user reviews.",
        "source_api_meta": "~50,000 titles",
        "source_spy_icon": "",
        "source_spy_name": "SteamSpy",
        "source_spy_desc": "Estimated player counts, CCU history, and genre tagging sourced from SteamSpy's community-maintained dataset. Used for retention curves.",
        "source_spy_meta": "13 months · Apr 2025 – Apr 2026",
        "source_kaggle_icon": "",
        "source_kaggle_name": "Kaggle Dataset",
        "source_kaggle_desc": "Supplemental publisher / developer relationship data and historical pricing from a curated Kaggle export. Cross-validated against live API responses.",
        "source_kaggle_meta": "Snapshot: Apr 2026",
    ...
    ru: {
        ...
        "hero_eyebrow": "Торговая площадка Steam · Интерактивная история данных",
        "hero_title": "50 000+ игр. Что данные\nна самом деле <em>говорят</em> о том, как мы играем?",
        "hero_sub": "Шесть интерактивных визуализаций, созданных на основе реальных данных Steam —\nкаждая отвечает на вопрос, о котором вы даже не задумывались.",
        "stat_games": "3 139",
        "stat_games_label": "Игр отслежено",
        "stat_viz": "6",
        "stat_viz_label": "Визуализаций",
        "stat_months": "13 мес",
        "stat_months_label": "данных",
        "explore": "Исследовать",
        "stories_label": "Истории",
        "stories_headline": "Каждая глава — это другой взгляд на один и тот же рынок.\nНажмите на любую карточку, чтобы погрузиться глубже.",
        "explore_cta": "Исследовать →",
        
        "arc_index": "01 — Граф-дуга",
        "arc_question": "Действительно ли геймеры меняют своё мнение?",
        "arc_insight": "Отслеживает, как изменилось восприятие обзоров 3 139 самых обсуждаемых игр — и как часто это изменение происходит в негативную сторону.",
        "arc_tag": "3 139 игр · Апрель 2026",
        "arc_improving": "улучшение",
        "arc_worsening": "ухудшение",
        
        "ccu_index": "02 — График CCU",
        "ccu_question": "Какие игры удерживают игроков, а какие исчезают за одну ночь?",
        "ccu_insight": "Кривые одновременных игроков за 13 месяцев показывают, какие проекты создают долгосрочные сообщества, а какие — однодневки.",
        "ccu_tag": "13 месяцев · Удержание игроков",
        "ccu_long_tail": "Долгий хвост",
        "ccu_flash": "Вспышка на пан",
        
        "dial_index": "03 — Циферблат",
        "dial_question": "Какая игра абсолютно лучшая — по любым выбранным вами параметрам?",
        "dial_insight": "Вращайте четыре концентрических кольца — Жанр, Метрика, Тип игрока, Платформа — и находите лучшее из лучшего для ваших точных фильтров.",
        "dial_tag": "4 оси · Интерактивные кольца",
        "dial_genre": "ЖАНР",
        "dial_metric": "МЕТРИКА",
        "dial_player": "ИГРОК",
        "dial_best": "ЛУЧШИЕ",
        ...
        "treemap_index": "04 — Древовидная карта",
        "treemap_question": "Кто на самом деле контролирует рынок Steam?",
        "treemap_insight": "Вложенная карта издателей и их разработчиков — посмотрите, кто доминирует по объёму и сколько территории на самом деле занимают гиганты.",
        "treemap_tag": "40+ издателей · Разбивка по разработчикам",
        
        "spiral_index": "05 — Спиральный график",
        "spiral_question": "Как менялся объём выпуска игр — год за годом, жанр за жанром?",
        "spiral_insight": "Временная спираль, которая разворачивает каждый год наружу, показывая волны релизов, сезонные паттерны и долгую дугу роста Steam.",
        "spiral_tag": "Временной ряд · История релизов",
        
        "radar_index": "06 — Радарная диаграмма",
        "radar_question": "Действительно ли игра с 10 миллионами игроков лучше той, у которой 100 000?",
        "radar_insight": "Сравните любые две игры по шести параметрам одновременно — рейтинг, продажи, игроки, удержание, обзоры и часы игры.",
        "radar_tag": "6 параметров · Сравнение",
        "radar_rating": "РЕЙТИНГ",
        "radar_sales": "ПРОДАЖИ",
        "radar_players": "ИГРОКИ",
        "radar_retention": "УДЕРЖАНИЕ",
        ...
        "data_tagline": "Все визуализации основаны на трёх дополнительных источниках, собранных и перекрёстно проверенных в апреле 2026 года.",
        "source_api_icon": "🛒",
        "source_api_name": "Steam Store API",
        "source_api_desc": "Метаданные игр, оценки обзоров и оценки владельцев, полученные напрямую из публичных точек Valve. Охватывает игры не менее чем с 10 пользовательскими обзорами.",
        "source_api_meta": "~50 000 позиций",
        "source_spy_icon": "📊",
        "source_spy_name": "SteamSpy",
        "source_spy_desc": "Расчётное количество игроков, история CCU и жанровая разметка из общедоступного набора данных SteamSpy. Используется для кривых удержания.",
        "source_spy_meta": "13 месяцев · Апрель 2025 – Апрель 2026",
        "source_kaggle_icon": "📁",
        "source_kaggle_name": "Kaggle Dataset",
        "source_kaggle_desc": "Дополнительные данные об отношениях издателей и разработчиков, а также исторические цены из курируемого экспорта Kaggle. Перекрёстно проверено с ответами живого API.",
        "source_kaggle_meta": "Снимок: Апрель 2026",
